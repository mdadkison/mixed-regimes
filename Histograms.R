...
####################################################################
#### histograms from spawner error sims ##########################
fnames <- c(
  "mixedSerror/RPreciseOverhSameHistartSpErrSims.txt",
  "mixedSerror/RPreciseNormhSameHistartSpErrSims.txt",
  "mixedSerror/RPreciseUnderhSameHistartSpErrSims.txt",
  "mixedSerror/RImpreciseOverhSameHistartSpErrSims.txt",
  "mixedSerror/RImpreciseNormhSameHistartSpErrSims.txt",
  "mixedSerror/RImpreciseUnderhSameHistartSpErrSims.txt")
